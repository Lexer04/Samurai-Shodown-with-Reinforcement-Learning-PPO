...
def parse_cmdline(argv):
    ...
    parser.add_argument('--p1_alg', type=str, default='ppo')
    parser.add_argument('--p2_alg', type=str, default='ppo')
    ...
    parser.add_argument('--env', type=str, default='SamuraiShodown-Genesis')
    parser.add_argument('--state', type=str, default='Level1.HaohmaruVsWanFu.2P')
